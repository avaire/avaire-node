...
/**
 * I Am Command, allows users to claim roles
...
class IAmCommand extends Command {
    ...
    constructor() {
        ...
        /**
         * The message that should be sent if the user was given the role successfully.
         *
         * @type {String}
         */
        this.message = '<@:userid> You now have the **:role** role!';
    }
    ...
    onCommand(sender, message, args) {
        ...
        return app.database.getGuild(app.getGuildIdFrom(message)).then(guild => {
            ...
            return message.member.assignRole(role).then(() => Module.sendRoleMessage(message, role, this.message)).catch(err => {
